...
- Enemy uses `badguy1.png` (4x4, 40x51) with directional animations and enters from above on start (spawned off-screen with physics body disabled until tween completes). Corpse now lingers on death.
